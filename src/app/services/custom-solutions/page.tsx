    ...
    <div className="bg-white font-sans text-slate-900">
      ...
      <section className="relative pt-20 pb-12 lg:pt-40 lg:pb-32 overflow-hidden bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 font-bold text-xs lg:text-sm tracking-wide mb-6 lg:mb-8">
          ...
          <h1 className="text-4xl lg:text-7xl font-extrabold leading-tight tracking-tight text-slate-900 mb-6 lg:mb-8 max-w-4xl mx-auto">
            ...
            <span className="text-indigo-600">Özel Teknoloji Çözümleri</span>
          </h1>
          ...
          <div className="flex justify-center gap-4">
            <Link
              href="/contact"
              className="bg-indigo-600 text-white px-6 py-3 lg:px-8 lg:py-4 rounded-xl font-bold hover:bg-indigo-700 transition-all hover:scale-105 shadow-xl shadow-indigo-500/20 flex items-center gap-2 text-sm lg:text-base"
            >
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 border-b border-slate-100">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="w-16 h-16 bg-indigo-100 text-indigo-600 rounded-2xl flex items-center justify-center shadow-sm shadow-indigo-100">
            ...
            <div className="grid grid-cols-1 gap-4 pt-4">
              <div className="flex gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <LineChart className="w-6 h-6 text-indigo-600 flex-shrink-0" />
                <div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 order-1 lg:order-2">
            ...
            <div className="grid grid-cols-1 gap-4 pt-4">
              ...
              <div className="flex gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <Layers className="w-6 h-6 text-indigo-600 flex-shrink-0" />
                <div>
